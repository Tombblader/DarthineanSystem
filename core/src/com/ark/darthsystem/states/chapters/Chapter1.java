        ...
        chapters.add((Page) () -> {
            switch(choices) {
                ...
                case "Hey Sexy.":
                    ...
                    BattleDriver.printline(Database2.player.getBattler(0), ActorSprite.SpriteModeFace.NORMAL, "I'm afraid so.  If someoneone had something like that's child, it would be difficult to explain..");
