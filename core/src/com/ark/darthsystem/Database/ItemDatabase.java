...
public class ItemDatabase {
    ...
    public static Equipment Wooden_Staff =
            new Equipment("Wooden Staff", Equipment.EquipmentType.RightArm, null,
            false, 2, 0, 0, 0);
    public static Equipment Bronze_Sword =
            new Equipment("Bronze Sword", Equipment.EquipmentType.RightArm, null,
            false, 6, 0, 0, 0);
    ...
    public static Equipment Wooden_Sword =
            new Equipment("Wooden Sword", Equipment.EquipmentType.RightArm, null,
            false, 2, 0, 0, 0);
    public static Equipment Blue_Javelin =
            new Equipment("Blue Javelin", Equipment.EquipmentType.RightArm,
    ...
    public static Equipment White_Sword =
            new Equipment("White Sword", Equipment.EquipmentType.RightArm, null,
    ...
    public static Equipment Golden_Axe =
            new Equipment("Golden Axe", Equipment.EquipmentType.RightArm,
    ...
    public static Equipment Violet_Staff =
            new Equipment("Violet Staff", Equipment.EquipmentType.RightArm,
            SkillDatabase.Storm_Gigas, Battle.Element.Wind, false, 2, 0, 20, 0);
    public static Equipment Dark_Saber =
            new Equipment("Dark Saber", Equipment.EquipmentType.RightArm, null,
            Battle.Element.Dark, false, 31, 0, 0, 5);
    public static Equipment Red_Sword =
            new Equipment("Red Sword", Equipment.EquipmentType.RightArm,
    ...
    public static Equipment Grooved_Gauntlet =
            new Equipment("Grooved Gauntlet", Equipment.EquipmentType.LeftArm,
            null, false, 0, 8, 2, 0);
    ...
    public static Equipment Bronze_Spear =
            new Equipment("Bronze Spear", Equipment.EquipmentType.RightArm, null,
            false, 7, 0, 0, 0);
    ...
    public static Equipment Iron_Shield =
            new Equipment("Iron Shield", Equipment.EquipmentType.LeftArm, null,
            false, 0, 5, 0, 0);
    public static Item Tonic =
            new Item("Tonic", true, SkillDatabase.Revivify, false);
    public static Equipment Hand_Axe =
            new Equipment("Hand_Axe", Equipment.EquipmentType.RightArm, null,
            false, 8, 0, 0, 0);
    public static Equipment Crest_Shield =
            new Equipment("Crest Shield", Equipment.EquipmentType.LeftArm, null,
            false, 0, 7, 0, 3);
    ...
    public static Equipment Wooden_Shield =
            new Equipment("Wooden Shield", Equipment.EquipmentType.LeftArm, null,
            false, 0, 1, 0, 0);
    public static Equipment Bronze_Shield =
            new Equipment("Bronze Shield", Equipment.EquipmentType.LeftArm, null,
            false, 0, 3, 0, 0);
